...
UPLOADS_DIR = os.path.join(DATA_DIR, "uploads")                     # 聊天附件（图片/长文本临时文档）
WORKSPACES_DIR = os.path.join(BASE_DIR, "workspaces")
WEB_DIR = os.path.join(BASE_DIR, "web")
SKILLS_DIR = os.path.join(BASE_DIR, "skills")                       # AgentChat 技能库（按 agent 勾选分发）
MEMORIES_DIR = os.path.join(BASE_DIR, "memories")                   # 记忆库（按 agent 勾选复制副本，独立演化）
...
def ensure_dirs():
    for d in (DATA_DIR, LOG_DIR, MCP_DIR, UPLOADS_DIR, WORKSPACES_DIR, SKILLS_DIR, MEMORIES_DIR, SHARED_DIR):
